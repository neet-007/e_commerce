...
export const Footer: React.FC<ComponentProps<"div"> & FooterProps> = ({ ...props }) => {
	...
	return (
		<div className="footer-container" {...props}>
			<ul className="footer-email list-none">
				<li className="h4">sign up for email</li>
			</ul>
			<div className="footer-help">
				<div className="h4 footer-section-header">
					<div>help</div>
					<div onClick={() => setHelpExpanded(prev => !prev)}
						className="footer-open-icon">
						+
					</div>
				</div>
				<ul className={`footer-help-list list-none
						${helpExpanded ? "footer-list-open" :
						""}`}>
					<li>order status</li>
					<li>dispatch and deleivry</li>
					<li>returns</li>
			...
			<div className="footer-about">
				<div className="h4 footer-section-header">
					<div>about</div>
					<div onClick={() => setAboutExpanded(prev => !prev)}
						className="footer-open-icon"
					>
						+
					</div>
				</div>
				<ul className={`footer-about-list list-none
						${aboutExpanded ? "footer-list-open" :
						""}`}>
					<li>news</li>
					<li>careaes</li>
					<li>investors</li>
			...
			<ul className="footer-social-media list-none">
				<li>
			...
			<div>
				<div className="h4 footer-section-header">
					<div>terms and coinditions</div>
					<div onClick={() => setTermsExpanded(prev => !prev)}
						className="footer-open-icon">
						+
					</div>
				</div>
				<ul className={`footer-terms list-none
						${termsExpanded ? "footer-list-open" :
						""}`}>
					<li>Eligibility</li>
